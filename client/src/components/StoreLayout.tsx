  ...
  return (
    <><SeoJsonLd id="mousa-organization-jsonld" data={organizationJsonLd(settings.data || {})} /><div dir="rtl" className="min-h-screen overflow-x-hidden bg-[#08090d] text-[#f5f0e8]">
      ...
      <div className="pt-[72px] md:pt-[112px]">
        {isCatalogStaging && <aside className="border-b border-amber-300/20 bg-amber-300/10 px-4 py-3 text-center text-xs leading-6 text-amber-100" aria-live="polite" aria-atomic="true">هذا عرض تجريبي يستخدم منتجات وصورًا مولّدة للاختبار فقط. تفاصيل الأسعار والمخزون وبيانات التواصل والدفع والتوصيل والضرائب والاستبدال والشروط القانونية تنتظر اعتماد إدارة المتجر؛ لذلك لا يمكن إتمام طلبات حقيقية.</aside>}
        {children}
      </div>
