...
| Operational engineering | `/healthz` plus the managed-edge-compatible `/api/healthz` alias, non-blocking owner alerts, request-correlation headers, CI validation, production dependency audit, and operations documentation are present. | Hosted GitHub Actions runs 32655491665 and 32664773989, plus local release validation. |
