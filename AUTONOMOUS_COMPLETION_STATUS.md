...
| Media and accessibility | Five source-recorded generated staging images and their five 480px derivatives are verified; the category banner has responsive 768/960 WebP sources; published Home and the rechecked Shop route have 100 Accessibility with no active contrast or ARIA-role finding. | Staging asset verifier, local and published Shop visual review, and published Lighthouse reports. |
