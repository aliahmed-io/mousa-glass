...
A cache-busted public retrieval at `?release=ab968017` confirmed that the published deployment serves the corrected Arabic wording: the configured contact method is **for enquiries only**, while commercial, operational, payment, and legal details await approval and real orders cannot be completed. The prior non-cache-busted extraction was therefore not treated as evidence of a deployment mismatch.
